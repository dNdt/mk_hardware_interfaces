...
public:
    ...
    //**********************************************************************
    virtual int tx ( const uint8_t* const  p_array_tx, const uint8_t& length, const uint32_t& timeout_ms ) const = 0;
    ...
    //**********************************************************************
    virtual int tx ( const uint8_t* const  p_array_tx, uint8_t* p_array_rx, const uint16_t& length, const uint32_t& timeout_ms ) const = 0;
    ...
    //**********************************************************************
    virtual int tx_one_item ( const uint8_t* const  p_item_tx, const uint16_t& count, const uint32_t& timeout_ms ) const = 0;
    ...
    //**********************************************************************
    virtual int rx ( void* p_array_rx, const uint16_t& length, const uint32_t& timeout_ms, const uint8_t& out_value = 0xFF ) const = 0;
